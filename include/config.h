...
#define FFMPEG_CONFIGURATION "--extra-cflags='-fno-common -I/xbmc/lib/win32/ffmpeg_dxva2 -DNDEBUG' --extra-ldflags=-L/xbmc/system/players/dvdplayer --enable-shared --enable-memalign-hack --enable-gpl --enable-w32threads --enable-postproc --enable-zlib --disable-static --disable-debug --disable-ffplay --disable-ffserver --disable-ffmpeg --disable-ffprobe --disable-devices --disable-doc --disable-crystalhd --enable-muxer=spdif --enable-muxer=adts --enable-muxer=asf --enable-muxer=ipod --enable-muxer=ogg --enable-encoder=ac3 --enable-encoder=aac --enable-encoder=wmav2 --enable-encoder=libvorbis --enable-protocol=http --enable-runtime-cpudetect --enable-dxva2 --cpu=i686 --enable-gnutls"
